...
// mongobase errors and original mongo errors mapeed as mongobase errors
var (
...
// NewBaseCollection initialises a new collection to handle quueries in it.
//
...
// Delete deletedd an existing document in the database based on the 'id' parameter. It tries to
...
// GetCollectionName returns currenttly set collection
...
// will also be set automatically, no neet to manually set
...
//
// The 'db' parameter can't be null, otherwise errors will be throwned everywhere.
