...
const (
	collectionName = "user_reset_types"
)

type ResetTypesService struct {
...
func New(services *structures.RequestValues) *ResetTypesService {
	s := &ResetTypesService{}
	s.services = services
...
func (s *ResetTypesService) List(filter bson.D) (*models.UserResetTypesModel, *logger.HttpError) {
	...
	docs := &models.UserResetTypesModel{
		Count: count,
	}
...
func (s *ResetTypesService) Get(filter bson.D, model *models.UserResetTypeModel) *logger.HttpError {
...
func (s *ResetTypesService) Create(model *models.UserResetTypeModel) *logger.HttpError {

	if err := s.Validate(model); err != nil {
		return err
	}

	exists := &models.UserResetTypeModel{}
	if err := s.Get(
...
func (s *ResetTypesService) Update(model *models.UserResetTypeModel) *logger.HttpError {
...
func (s *ResetTypesService) Delete(model *models.UserResetTypeModel) *logger.HttpError {
...
func (m *ResetTypesService) Validate(model *models.UserResetTypeModel) *logger.HttpError {
...
func (s *ResetTypesService) assign(to *models.UserResetTypeModel, from *models.UserResetTypeModel, operation services.Operation) {
