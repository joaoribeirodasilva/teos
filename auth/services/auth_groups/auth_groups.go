...
func New(services *structures.RequestValues) *AuthGroupsService {
	s := &AuthGroupsService{}
	s.services = services
...
func (s *AuthGroupsService) assign(to *models.AuthGroup, from *models.AuthGroup, operation services.Operation) {
